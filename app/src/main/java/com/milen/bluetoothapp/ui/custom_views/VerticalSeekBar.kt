...
constructor(
    ...
    init {
        ...
        icon =  typedArray.getDrawable(R.styleable.VerticalSeekBar_button_icon) as VectorDrawable
        val iconSize = typedArray.getDimensionPixelSize(R.styleable.VerticalSeekBar_button_icon_size, 0)
        icon.setBounds(0, 0, iconSize, iconSize)

        strokeWidth = typedArray.getDimensionPixelSize(R.styleable.VerticalSeekBar_stroke_width, 0).toFloat()
        drawingPaint.strokeWidth = strokeWidth

        strokeColor = typedArray.getColor(R.styleable.VerticalSeekBar_stroke_color, Color.WHITE)
        buttonFillColor = typedArray.getColor(R.styleable.VerticalSeekBar_button_color, Color.BLACK)
        buttonFillColorPressed = typedArray.getColor(R.styleable.VerticalSeekBar_button_color_pressed, Color.BLUE)

        val minValue = typedArray.getFloat(R.styleable.VerticalSeekBar_min_value, 0f)
        val maxValue = typedArray.getFloat(R.styleable.VerticalSeekBar_max_value, 0f)
